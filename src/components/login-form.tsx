              ...
              <div className="grid gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      required
                      className="pl-11 bg-gray-800/50 border-gray-700 text-white placeholder:text-gray-500 focus:border-purple-500 focus:ring-purple-500/20 h-12 rounded-lg transition-all duration-200"
                    />
                  </div>
                </div>
                ...
                {/* <div className="grid grid-cols-2 gap-4">
                  <Button
                    ...
                    className="h-12 bg-gray-800/50 border-gray-700 hover:bg-gray-800 hover:border-gray-600 text-white transition-all duration-200"
                  >
                    {googleLoading ? (
                      <Loader2 className="w-5 h-5 animate-spin" />
                    ) : (
